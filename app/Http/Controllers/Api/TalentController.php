...
class TalentController extends Controller
{
    ...
    public function drawTalent(Request $request, TalentService $talentService)
    {
        ...
        // 抽獎
        $drawResult = $talentService->executeDraw($user, $talentPool['session_id'], $talentPool['items'] ?? []);
        ...
        return response()->json(['data' => $results, 'finishedTasks' => $formattedTaskResult], 200);
    }
    ...
    private function getAllTaskStatus($user)
    {
        ...
        $gradeSerivce->updateByKeyword($user, 'talent');
