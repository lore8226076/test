    ...
    public static function errorCode($from, $error)
    {
        switch ($error) {
            ...
            case 'GachaOrder:0006':
                ...
                break;
            case 'GachaOrder:0007':
                return self::returnData($from, $error, __('獲得英雄失敗'), 'obtain_character_failed');
                break;
            case 'GachaOrder:0008':
                return self::returnData($from, $error, __('抽取英雄失敗'), 'draw_character_failed');
                break;
            case 'GachaOrder:0009':
                return self::returnData($from, $error, __('抽取英雄系統錯誤'), 'draw_character_system_error');
                break;
            case 'GachaOrder:0010':
                return self::returnData($from, $error, __('免費抽取次數已用完'), 'free_draw_exhausted');
                break;
            case 'GachaOrder:0011':
                return self::returnData($from, $error, __('免費抽取只能單抽'), 'free_draw_single_only');
                break;
            case 'GachaOrder:0012':
                return self::returnData($from, $error, __('扭蛋花費道具取得錯誤'), 'currency_item_error');
                break;
            ...
            case 'STAGE:0005':
                ...
                // surgame資源關卡錯誤
            case 'SURGAME_RESOURCE:0001':
                return self::returnData($from, $error, __('關卡ID 錯誤'), 'stage_unique_id');
                break;
            case 'SURGAME_RESOURCE:0002':
                return self::returnData($from, $error, __('關卡已標記為清除'), 'stage_already_cleared');
                break;
            case 'SURGAME_RESOURCE:0003':
                return self::returnData($from, $error, __('關卡資料不存在'), 'stage_not_found');
                break;
            case 'SURGAME_RESOURCE:0004':
                return self::returnData($from, $error, __('獎勵發放失敗'), 'reward_distribution_failed');
                break;
            case 'SURGAME_RESOURCE:0005':
                return self::returnData($from, $error, __('關卡類型錯誤'), 'stage_type_error');
                break;
            case 'SURGAME_RESOURCE:0006':
                return self::returnData($from, $error, __('掃蕩次數不合法'), 'sweep_count_invalid');
                break;
            case 'SURGAME_RESOURCE:0007':
                return self::returnData($from, $error, __('尚未通關無法掃蕩'), 'stage_not_cleared');
                break;
            case 'SURGAME_RESOURCE:0008':
                return self::returnData($from, $error, __('付費掃蕩次數不足'), 'paid_sweep_not_enough');
                break;
            case 'SURGAME_RESOURCE:0009':
                return self::returnData($from, $error, __('用戶遊戲資訊不存在'), 'user_game_info_not_found');
                break;
            case 'SURGAME_RESOURCE:0010':
                return self::returnData($from, $error, __('付費貨幣不足'), 'paid_currency_not_enough');
                break;
            case 'SURGAME_RESOURCE:0011':
                return self::returnData($from, $error, __('免費掃蕩次數不足'), 'free_sweep_not_enough');
                break;
            ...
            case 'PATROL:0002':
                ...
                break;
            case 'PATROL:0003':
                return self::returnData($from, $error, __('巡邏體力扣除失敗'), 'patrol_data_error');
                break;
            case 'PATROL:0004':
                return self::returnData($from, $error, __('剩餘巡邏次數不足'), 'patrol_count_not_enough');
            ...
            case 'INVENTORY:0006':
                ...
                break;
            case 'INVENTORY:0007':
                return self::returnData($from, $error, __('使用道具數量與自選數量不相符'), 'item_amount_mismatch');
                break;
            ...
            case 'TALENT:0002':
                ...
                break;
            case 'TALENT:0003':
                return self::returnData($from, $error, __('天賦獎池已空或抽獎失敗'), 'talent_pool_empty');
                break;
            case 'TALENT:0004':
                return self::returnData($from, $error, __('天賦抽取記錄失敗'), 'talent_log_failed');
                break;
            case 'TALENT:0005':
            ...
            case 'TALENT:0007':
                ...
                break;
            case 'TALENT:0008':
                return self::returnData($from, $error, __('天賦獎池等級綁定資料錯誤'), 'talent_pool_level_bind_error');
                break;
            case 'TALENT:0009':
                return self::returnData($from, $error, __('天賦獎池不存在或已完成'), 'talent_pool_inactive');
                break;
            case 'TALENT:0010':
                return self::returnData($from, $error, __('無法取得天賦抽取花費資訊'), 'talent_cost_not_found');
                break;
            case 'TALENT:0011':
                return self::returnData($from, $error, __('扣除天賦抽取花費失敗'), 'talent_cost_deduct_failed');
                break;

                // 月卡系統錯誤資訊
            case 'MonthCard:0001':
                return self::returnData($from, $error, __('已達月卡購買上限'), 'month_card_purchase_limit');
                break;
            case 'MonthCard:0002':
                return self::returnData($from, $error, __('未擁有此月卡'), 'month_card_not_owned');
                break;
            case 'MonthCard:0003':
                return self::returnData($from, $error, __('月卡已過期'), 'month_card_expired');
                break;
            case 'MonthCard:0004':
                return self::returnData($from, $error, __('今日已領取月卡獎勵'), 'month_card_daily_claimed');
                break;
            case 'MonthCard:0005':
                return self::returnData($from, $error, __('月卡ID不可為空'), 'month_card_unique_id_required');
                break;
            case 'MonthCard:0006':
                return self::returnData($from, $error, __('月卡不存在'), 'month_card_config_not_found');
                break;
